...
$url = '/catalog/testcatalog';
    ...
    response_content_like    [GET => $url],     qr|href="http://www\.google\.com/search|,                       "$url: Default product url is listed";
    response_content_like    [GET => $url],     qr|href="http://TestApp\.example\.com"|,                        "$url: Specific product url is listed";
...
foreach $url (qw( /catalog/testcatalog/json /catalog/testcatalog/exists /catalog/testnotthere/exists )) {
